  ...
  const tabs = [
    
     {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-700 to-violet-900">
          ...
          <ImageContainer src="/images/zomato_landing.png" href="https://zomato-landing-page-gules-two.vercel.app" />
        </div>
      ),
    },
    {
...

    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-700 to-violet-900">
          <p>My Portfolio</p>
          <ImageContainer src="/images/portfolio_div.png" href="https://divyesh-intial-portfolio.vercel.app/" />
        </div>
      ),
    },
    {
